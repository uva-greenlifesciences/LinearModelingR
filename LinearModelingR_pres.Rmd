...
The best estimate minimizes the sum of squared errors. 2D example: line with intercept $\hat{\beta_{0}}$ and slope $\hat{\beta_{1}}$ with squared and summed distances of red lines (ie, errors) as small as possible.
